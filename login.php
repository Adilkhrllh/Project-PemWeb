...
<body>
        ...
        <div class="form-container sign-up">
            <form action="logic/auth.php" method="POST">
                ...
                if (isset($_GET['status'])) {
                    ...
                    // STATUS YANG MUNCUL DI REGISTER (gagal)
        ...
        <div class="form-container sign-in">
            <form action="logic/auth.php" method="POST">
                ...
                if (isset($_GET['status'])) {
                    ...
                    // STATUS YANG MUNCUL DI SIGN IN (berhasil)
                    $signin_success = ["berhasil_mendaftar", "login_berhasil", "gagal_login"];
    ...
    // Jika BERHASIL mendaftar → tampilkan SIGN IN
    if (url.get('signin') === "1") {
        document.getElementById('container').classList.remove("active");
    }

    // Jika gagal register → tetap di REGISTER
