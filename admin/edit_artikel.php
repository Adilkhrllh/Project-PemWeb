...
if($id_artikel <= 0){
    header("Location: dashboard.php?page=artikel&status=invalid_id");
    exit;
}
...
if(mysqli_num_rows($result) == 0){
    header("Location: dashboard.php?page=artikel&status=artikel_not_found");
    exit;
}
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a href="dashboard.php?page=artikel" class="active">Lihat Artikel</a>
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <p class="page-subtitle">Perbarui konten artikel yang sudah ada</p>
            </div>
            ...
            <?php if(isset($_GET['status'])): ?>
                ...
                <?php elseif($_GET['status'] == 'error'): ?>
                    <div class="alert alert-error">
                        <span style="font-size: 20px;">✗</span>
                        <span>Gagal memperbarui artikel. Silakan coba lagi.</span>
                    </div>
                <?php elseif($_GET['status'] == 'empty'): ?>
                    <div class="alert alert-error">
                        <span style="font-size: 20px;">⚠</span>
                        <span>Judul dan konten artikel wajib diisi!</span>
                    </div>
                ...
                <?php elseif($_GET['status'] == 'judul_terlalu_panjang'): ?>
                    <div class="alert alert-error">
                        <span style="font-size: 20px;">⚠</span>
                        <span>Judul terlalu panjang! Maksimal 200 karakter.</span>
                    </div>
                <?php endif; ?>
            <?php endif; ?>

            <div class="artikel-info">
                <strong>ID Artikel:</strong> <?= $artikel['id_artikel'] ?> &nbsp;|&nbsp;
                <strong>Dibuat:</strong> <?= date('d F Y, H:i', strtotime($artikel['created_at'])) ?> WIB
            </div>

            <div class="form-card">
                <form action="../logic/proses_edit_artikel.php" method="POST" id="artikelForm">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            oninput="updateCharCount('judul', 'judulCount', 200); updatePreview()">
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            ...
                            required
                            oninput="updateCharCount('konten', 'kontenCount', 10000); updatePreview()"><?= htmlspecialchars($artikel['konten']) ?></textarea>
                        <div class="char-count">
                    ...
                    <div class="preview-section">
                        ...
                        <div class="preview-content" id="previewContent">
                            <em style="color: #999;">Preview akan muncul di sini...</em>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            if(!judul && !konten) {
                preview.innerHTML = '<em style="color: #999;">Preview akan muncul di sini...</em>';
                return;
            }
